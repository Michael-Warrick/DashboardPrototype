...
Renderer::Renderer(GLFWwindow *window) {
    ...
    m_HomeTilePositions = {
        // Left Column
        glm::vec3(- 0.66f, 2.0f, -6.0f),
        glm::vec3( - 0.66f, 1.0f, -6.0f),
        glm::vec3( - 0.66f, 0.0f, -6.0f),

        // Middle Column
        glm::vec3(2.0f, 1.5f, -6.0f),
        glm::vec3(1.0f + (m_TileOffset / 2.0f), 0.0f, -6.0f),
        glm::vec3(3.0f - (m_TileOffset / 2.0f), 0.0f, -6.0f),

        // Right Column
        glm::vec3(4.66f, 2.0f, -6.0f),
        glm::vec3(4.66f, 1.0f, -6.0f),
        glm::vec3(4.66f, 0.0f, -6.0f)
    };
    ...
    m_HomeTileScales = {
        ...
        // Middle Column
        glm::vec3(3.0f * m_TileWidth, 2.0 + m_TileOffset, 1.0f),
        glm::vec3(1.5f * m_TileWidth - (m_TileOffset / 2.0f), m_TileHeight, 1.0f),
        glm::vec3(1.5f * m_TileWidth - (m_TileOffset / 2.0f), m_TileHeight, 1.0f),
